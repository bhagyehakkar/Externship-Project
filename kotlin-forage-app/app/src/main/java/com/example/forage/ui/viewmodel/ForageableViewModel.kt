...
class ForageableViewModel(
    ...
    val forageables: LiveData<List<Forageable>> = forageableDao.getAllForegeables().asLiveData()
    ...
    fun getForageable(id: Long): LiveData<Forageable> =
        forageableDao.getForageableById(id).asLiveData()
    ...
    // TODO: launch a coroutine and call the DAO method to add a Forageable to the database within it
        viewModelScope.launch {
            forageableDao.insertfgcaseable(forageable)
        }
